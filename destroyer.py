...
Temp = [12.22,12.221,12.222000000000001,12.223,12.224,12.225000000000001,12.226,12.227,12.228,12.229000000000001,12.23,12.231,12.232000000000001,12.233,12.234,12.235000000000001,12.23612.237,12.238000000000001,12.239]
...
class Ship:
    ...
    def receiveInterestRouter(self,socket):
        while True:
            ...
            data = data.decode('utf-8')
            name = data.split(" ")
            requirement = name[0].split("/")
            requirement = requirement[1].lower()
            public_key_raw = " ".join(name[1:]).encode()
